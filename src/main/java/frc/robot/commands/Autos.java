...
public final class Autos {
  ...
  private static Command liftAndOuttake(LiftSystem lift, GripperSystem gripper, AddressableLEDSubsystem led) {
  ...
  public static Command rotateThenDriveAuto(DriveSystem driveSubsystem, GripperSystem gripper, AddressableLEDSubsystem led) {
    return Commands.sequence(
  ...
  public static Command backUpAndBalance(DriveSystem drivesystem, LiftSystem lift, GripperSystem gripper, AddressableLEDSubsystem led) {
    return Commands.sequence(
    ...
    public static Command outtakeAndBalance(DriveSystem drivesystem, LiftSystem lift, GripperSystem gripper, AddressableLEDSubsystem led) {
      return Commands.sequence(
  ...
  public static Command leftSideBlue(DriveSystem drivesystem, LiftSystem lift, GripperSystem gripper, AddressableLEDSubsystem led, Boolean additionalAuto) {
    return Commands.sequence(
      liftAndOuttake(lift, gripper, led),
  ...
  /** robot drives onto charge station, balances, drives out of community, then back onto charge station and balances */
  public static Command rightSideBlue(DriveSystem drivesystem, LiftSystem lift, GripperSystem gripper, AddressableLEDSubsystem led, Boolean additionalAuto) {
    return Commands.sequence(
      liftAndOuttake(lift, gripper, led),
      new RotateToAngle(Rotation2d.fromDegrees(-40), drivesystem).withTimeout(1),
      new DriveDistance(-0.5, 1, drivesystem), 
  ...
  public static Command leftSideRed(DriveSystem drive, LiftSystem lift, GripperSystem gripper, AddressableLEDSubsystem led, Boolean additionalAuto) {
    return Commands.sequence(
      liftAndOuttake(lift, gripper, led),
  ...
  public static Command rightSideRed(DriveSystem drive, LiftSystem lift, GripperSystem gripper, AddressableLEDSubsystem led, Boolean additionalAuto) {
    return Commands.sequence(
      liftAndOuttake(lift, gripper, led),
      new RotateToAngle(Rotation2d.fromDegrees(-40), drive).withTimeout(1),
      new DriveDistance(-0.5, 1, drive), 
